...
### 4. 🏥 Resistencia antimicrobiana en bacterias hospitalarias de Ecuador

**Descripción:** Análisis de genes y mecanismos de resistencia antimicrobiana en bacterias aisladas de entornos hospitalarios en Ecuador, utilizando herramientas bioinformáticas para la identificación de patrones de resistencia.
...
**Herramientas utilizadas:**
- ResFinder para identificación de genes de resistencia
...
### 5. 🧪 Identificación de genes relacionados con producción de compuestos antimicrobianos naturales en Streptomyces coelicolor

**Descripción:** Estudio bioinformático para identificar y caracterizar genes involucrados en la producción de compuestos antimicrobianos naturales en la bacteria Streptomyces coelicolor.
...
**Herramientas utilizadas:**
- antiSMASH para identificación de clusters biosintéticos
- BLAST para búsqueda de homólogos
...
### 6. 🦠 ESTUDIO COMPARATIVO DE OPERONES DE SÍNTESIS DE SIDERÓFOROS EN PSEUDOMONAS SPP.

**Descripción:** Análisis comparativo de operones involucrados en la síntesis de sideróforos en diferentes especies de Pseudomonas, utilizando herramientas bioinformáticas para identificar similitudes y diferencias en estos sistemas de captación de hierro.
...
**Herramientas utilizadas:**
- BLAST para búsqueda de genes ortólogos
- Clustal Omega para alineamientos múltiples
- MEGA para análisis filogenético
- Análisis de operones y sintenia
